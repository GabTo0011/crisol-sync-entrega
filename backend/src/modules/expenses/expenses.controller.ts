...
export class ExpensesController {
  ...
  @ApiOperation({
    ...
    description:
      'Registra un gasto manual o proveniente de OCR para un negocio.',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Listar todos los gastos de un negocio',
    description:
      'Retorna todos los gastos ordenados por fecha de emisión descendente. Soporta paginación opcional.',
  })
  @ApiQuery({
    name: 'businessId',
    required: false,
  ...
  @ApiQuery({
    name: 'limit',
    required: false,
    description: 'Items por página (default: 50, max: 100)',
  })
  @ApiResponse({
    status: 200,
    description: 'Lista de gastos retornada exitosamente.',
  })
  findAll(
  ...
  @Patch(':id/cancel')
  @ApiOperation({
    summary: 'Anular un gasto',
    description: 'Cambia el estado del gasto a CANCELLED (anulada).',
  })
